...
module resourceGroup_lock '../nested_lock.bicep' = if (!empty(lock ?? {}) && lock.?kind != 'None') {
...
module resourceGroup_roleAssignments '../nested_roleAssignments.bicep' = if (!empty(roleAssignments ?? [])) {
